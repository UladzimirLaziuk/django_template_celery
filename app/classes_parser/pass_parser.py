...
address_template = """Из следующего запроса выдели данные следующего формата:
            ...
            Если данных такого формата нет то верни-Наименование поставщика, адрес:НЕТ ДАННЫХ.ЭТО ОЧЕНЬ ВАЖНО НЕ НУЖНО ВОЗВРАЩАТЬ ПРИМЕР,ЕСЛИ НЕТ ДАННЫХ ВЕРНИ-Наименование поставщика, адрес:Нет данных.БЕЗ -.
            """
