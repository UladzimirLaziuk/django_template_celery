...
system_template = '''Из следующего запроса выдели данные следующего формата ПРОТОКОЛ № 04/30-04-11-J1/013-3DH-23.
        ...
        ПРОТОКОЛ № 234/30-04-11-h1/013-3fsg-123
        тел. 8(0222) 76-51-47, 76-51-53
        Ответ:
        Данные протокола: ПРОТОКОЛ № 234/30-04-11-h1/013-3fsg-123
        конец примера
